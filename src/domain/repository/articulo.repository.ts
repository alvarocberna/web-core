...
export abstract class ArticuloRepository{
    abstract createArticulo(createArticuloDto: CreateArticuloDto): Promise<ArticuloEntity>;
    abstract getArticuloById(id_proyecto: string, id_articulo: string): Promise<ArticuloEntity>;
